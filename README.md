# Description
This is a CSharp (C#) 🟪 a simple API to integrate and monitor 🖥️📈 with application insights. This is in order to study and practice for az204 certification exam 🤓📚🎓
...
### Request
```sh
$ curl --location 'http://localhost:8081/weatherforecast' 
```
